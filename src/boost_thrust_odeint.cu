...
// check https://github.com/headmyshoulder/odeint-v2/blob/master/examples/thrust/phase_oscillator_ensemble.cu for original sources
// opposed to the original documentation, the example works with ROCm/HIP and their Thrust version without modifications!
